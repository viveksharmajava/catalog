...
public class ProdCatalogController {
    ...
    @PutMapping("/{prodCatalogId}")
    public ResponseEntity<ProdCatalogDto> updateCatalog(@PathVariable String prodCatalogId,
                                                        @RequestBody ProdCatalogDto dto) {
        return ResponseEntity.ok(prodCatalogService.updateCatalog(prodCatalogId, dto));
    }
